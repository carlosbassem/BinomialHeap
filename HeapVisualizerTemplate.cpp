...
// ArrowItemT implementation
ArrowItemT::ArrowItemT(QPointF start, QPointF end, bool doubleArrow)
...
void ArrowItemT::updatePosition(QPointF start, QPointF end) {
    QLineF centerLine(start, end);
...
QPolygonF ArrowItemT::createArrowHead(QPointF start, QPointF end) {
...
void ArrowItemT::paint(QPainter* painter, const QStyleOptionGraphicsItem* option, QWidget* widget) {
    Q_UNUSED(option);
    Q_UNUSED(widget);
